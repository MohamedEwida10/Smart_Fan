...
# 12 "ECU_layer/Keypad/../../MCAL_layer/GPIO/hal_gpio.h"
...
# 14 "ECU_layer/Keypad/../../MCAL_layer/GPIO/../std_libraries.h"
...
# 12 "ECU_layer/Keypad/../../MCAL_layer/GPIO/../compiler.h" 2
...
# 36 "ECU_layer/Keypad/../../MCAL_layer/GPIO/hal_gpio.h"
typedef enum {
    LOW = 0,
    HIGH
}logic_t;
...
uint8 keypad_values[4][4] ={
                     {'7','8','9','/'},
                     {'4','5','6','*'},
                     {'1','2','3','-'},
                     {'#','0','=','+'}
};
# 25 "ECU_layer/Keypad/ecu_keypad.c"
STD_ReturnType ecu_keypad_initialize(const keypad_t *keypad){
