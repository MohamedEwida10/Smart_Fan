...
# 12 "ECU_layer/chr_LCD/../../MCAL_layer/GPIO/hal_gpio.h"
...
# 14 "ECU_layer/chr_LCD/../../MCAL_layer/GPIO/../std_libraries.h"
...
# 12 "ECU_layer/chr_LCD/../../MCAL_layer/GPIO/../compiler.h" 2
# 14 "ECU_layer/chr_LCD/../../MCAL_layer/GPIO/../mcal_std_types.h" 2
...
# 15 "ECU_layer/chr_LCD/../../MCAL_layer/GPIO/../mcal_std_types.h" 2
...
# 36 "ECU_layer/chr_LCD/../../MCAL_layer/GPIO/hal_gpio.h"
typedef enum {
    LOW = 0,
    HIGH
}logic_t;
...
# 8 "ECU_layer/chr_LCD/ecu_chr_LCD.c" 2
...
# 25 "ECU_layer/chr_LCD/ecu_chr_LCD.c"
STD_ReturnType lcd_4bit_initialize(const chr_lcd_4bit_t *lcd){
...
# 65 "ECU_layer/chr_LCD/ecu_chr_LCD.c"
STD_ReturnType lcd_4bit_send_command(const chr_lcd_4bit_t *lcd,uint8 command){
STD_ReturnType ret = (STD_ReturnType)0x01;
...
# 125 "ECU_layer/chr_LCD/ecu_chr_LCD.c"
STD_ReturnType lcd_4bit_send_char_data_pos(const chr_lcd_4bit_t *lcd,uint8 row,uint8 column,uint8 data){
STD_ReturnType ret = (STD_ReturnType)0x01;
    if(((void*)0) == lcd)
    {
...
# 146 "ECU_layer/chr_LCD/ecu_chr_LCD.c"
STD_ReturnType lcd_4bit_send_string(const chr_lcd_4bit_t *lcd,uint8 *str){
STD_ReturnType ret = (STD_ReturnType)0x01;
    if(((void*)0) == lcd)
    {
...
# 172 "ECU_layer/chr_LCD/ecu_chr_LCD.c"
STD_ReturnType lcd_4bit_send_string_pos(const chr_lcd_4bit_t *lcd,uint8 row,uint8 column,uint8 *str){
STD_ReturnType ret = (STD_ReturnType)0x01;
    if(((void*)0) == lcd)
    {
...
# 200 "ECU_layer/chr_LCD/ecu_chr_LCD.c"
STD_ReturnType lcd_4bit_send_custome_char(const chr_lcd_4bit_t *lcd,uint8 row,uint8 column,
                                          const uint8 _chr[],uint8 mem_pos){
STD_ReturnType ret = (STD_ReturnType)0x01;
uint8 counter = 0;
...
# 227 "ECU_layer/chr_LCD/ecu_chr_LCD.c"
STD_ReturnType lcd_8bit_initialize(const chr_lcd_8bit_t *lcd){
STD_ReturnType ret = (STD_ReturnType)0x01;
uint8 counter = 0 ;
    if(((void*)0) == lcd)
...
# 267 "ECU_layer/chr_LCD/ecu_chr_LCD.c"
STD_ReturnType lcd_8bit_send_command(const chr_lcd_8bit_t *lcd,uint8 command){
STD_ReturnType ret = (STD_ReturnType)0x01;
uint8 counter = 0 ;
    if(((void*)0) == lcd)
...
# 295 "ECU_layer/chr_LCD/ecu_chr_LCD.c"
STD_ReturnType lcd_8bit_send_char_data(const chr_lcd_8bit_t *lcd,uint8 data){
STD_ReturnType ret = (STD_ReturnType)0x01;
uint8 counter = 0 ;
    if(((void*)0) == lcd)
...
# 324 "ECU_layer/chr_LCD/ecu_chr_LCD.c"
STD_ReturnType lcd_8bit_send_char_data_pos(const chr_lcd_8bit_t *lcd,uint8 row,uint8 column,uint8 data){
STD_ReturnType ret = (STD_ReturnType)0x01;
    if(((void*)0) == lcd)
    {
...
# 345 "ECU_layer/chr_LCD/ecu_chr_LCD.c"
STD_ReturnType lcd_8bit_send_string(const chr_lcd_8bit_t *lcd,uint8 *str){
STD_ReturnType ret = (STD_ReturnType)0x01;
    if(((void*)0) == lcd)
    {
...
# 371 "ECU_layer/chr_LCD/ecu_chr_LCD.c"
STD_ReturnType lcd_8bit_send_string_pos(const chr_lcd_8bit_t *lcd,uint8 row,uint8 column,uint8 *str){
STD_ReturnType ret = (STD_ReturnType)0x01;
    if(((void*)0) == lcd)
    {
...
# 399 "ECU_layer/chr_LCD/ecu_chr_LCD.c"
STD_ReturnType lcd_8bit_send_custome_char(const chr_lcd_8bit_t *lcd,uint8 row,uint8 column,
                                          const uint8 _chr[],uint8 mem_pos){
STD_ReturnType ret = (STD_ReturnType)0x01;
uint8 counter = 0;
...
# 427 "ECU_layer/chr_LCD/ecu_chr_LCD.c"
STD_ReturnType convert_byte_to_string(uint8 value,uint8 *str){
STD_ReturnType ret = (STD_ReturnType)0x01;
    if(((void*)0) == str)
    {
...
# 448 "ECU_layer/chr_LCD/ecu_chr_LCD.c"
STD_ReturnType convert_short_to_string(uint16 value,uint8 *str){
STD_ReturnType ret = (STD_ReturnType)0x01;
uint8 temp_str[6] = {0};
uint8 count = 0;
...
# 478 "ECU_layer/chr_LCD/ecu_chr_LCD.c"
STD_ReturnType convert_int_to_string(uint32 value,uint8 *str){
STD_ReturnType ret = (STD_ReturnType)0x01;
    if(((void*)0) == str)
    {
...
# 550 "ECU_layer/chr_LCD/ecu_chr_LCD.c"
static STD_ReturnType lcd_8bit_set_curser(const chr_lcd_8bit_t *lcd,uint8 row ,uint8 column ){
STD_ReturnType ret = (STD_ReturnType)0x01;
column--;
switch(row){
...
# 577 "ECU_layer/chr_LCD/ecu_chr_LCD.c"
static STD_ReturnType lcd_4bit_set_curser(const chr_lcd_4bit_t *lcd,uint8 row ,uint8 column ){
STD_ReturnType ret = (STD_ReturnType)0x01;
column--;
switch(row){
