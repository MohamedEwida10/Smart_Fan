...
# 15 "ECU_layer/Relay/../../MCAL_layer/GPIO/../std_libraries.h" 2
...
# 15 "ECU_layer/Relay/../../MCAL_layer/GPIO/../mcal_std_types.h" 2
...
# 36 "ECU_layer/Relay/../../MCAL_layer/GPIO/hal_gpio.h"
typedef enum {
    LOW = 0,
    HIGH
}logic_t;
...
# 40 "ECU_layer/Relay/ecu_relay.c"
STD_ReturnType ecu_relay_on(const relay_t *relay){
STD_ReturnType ret = (STD_ReturnType)0x01;
    if(((void*)0) == relay )
    {
...
# 63 "ECU_layer/Relay/ecu_relay.c"
STD_ReturnType ecu_relay_off(const relay_t *relay){
STD_ReturnType ret = (STD_ReturnType)0x01;
    if(((void*)0) == relay )
    {
