# 1 "ECU_layer/7_segment/ecu_seven_segment.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "ECU_layer/7_segment/ecu_seven_segment.c" 2
...
# 13 "ECU_layer/7_segment/../../MCAL_layer/GPIO/../mcal_std_types.h"
# 1 "ECU_layer/7_segment/../../MCAL_layer/GPIO/../std_libraries.h" 1
# 14 "ECU_layer/7_segment/../../MCAL_layer/GPIO/../std_libraries.h"
...
# 14 "ECU_layer/7_segment/../../MCAL_layer/GPIO/../std_libraries.h" 2
...
# 15 "ECU_layer/7_segment/../../MCAL_layer/GPIO/../std_libraries.h" 2
...
# 14 "ECU_layer/7_segment/../../MCAL_layer/GPIO/../mcal_std_types.h" 2
...
# 15 "ECU_layer/7_segment/../../MCAL_layer/GPIO/../mcal_std_types.h" 2
...
# 36 "ECU_layer/7_segment/../../MCAL_layer/GPIO/hal_gpio.h"
typedef enum {
    LOW = 0,
    HIGH
}logic_t;
...
# 8 "ECU_layer/7_segment/ecu_seven_segment.c" 2
...
STD_ReturnType ecu_seven_segment_initialize(const segment_t *seg){
  STD_ReturnType ret = (STD_ReturnType)0x01;
    ...
    {
        gpio_pin_initialize(&(seg->SegmentPins[0]));
        gpio_pin_initialize(&(seg->SegmentPins[1]));
        gpio_pin_initialize(&(seg->SegmentPins[2]));
        gpio_pin_initialize(&(seg->SegmentPins[3]));
    }
...
STD_ReturnType ecu_seven_segment_write_number(const segment_t *seg, uint8 number){
   STD_ReturnType ret = (STD_ReturnType)0x01;
    ...
    {
        gpio_pin_write_logic(&(seg->SegmentPins[0]) , number & 0x01 );
        gpio_pin_write_logic(&(seg->SegmentPins[1]) , (number >> 1)& 0x01 );
        gpio_pin_write_logic(&(seg->SegmentPins[2]) , (number >> 2)& 0x01 );
        gpio_pin_write_logic(&(seg->SegmentPins[3]) , (number >> 3)& 0x01 );
