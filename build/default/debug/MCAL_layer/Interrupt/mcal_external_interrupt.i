...
# 13 "MCAL_layer/Interrupt/mcal_interrupt_cfg.h"
...
# 32 "MCAL_layer/Interrupt/mcal_interrupt_gen_cfg.h"
typedef enum{
...
# 36 "MCAL_layer/Interrupt/../GPIO/hal_gpio.h"
typedef enum {
    LOW = 0,
    HIGH
}logic_t;
...
# 89 "MCAL_layer/Interrupt/mcal_external_interrupt.h"
...
# 48 "MCAL_layer/Interrupt/mcal_external_interrupt.c"
STD_ReturnType Interrupt_INTx_Init(const Interrupt_INTx_t *int_obj){
...
# 309 "MCAL_layer/Interrupt/mcal_external_interrupt.c"
static STD_ReturnType INTERRUPT_INTx_enable(const Interrupt_INTx_t *int_obj){
    STD_ReturnType ret = (STD_ReturnType)0x01;
    if(((void*)0) == int_obj)
    {
...
# 342 "MCAL_layer/Interrupt/mcal_external_interrupt.c"
                (INTCONbits.GIE = 1);
                (INTCONbits.PEIE = 1);
...
# 362 "MCAL_layer/Interrupt/mcal_external_interrupt.c"
                (INTCONbits.GIE = 1);
                (INTCONbits.PEIE = 1);
...
static STD_ReturnType INTERRUPT_INTx_disable(const Interrupt_INTx_t *int_obj){
    ...
    {
            switch(int_obj->source){
            case INTERRUPT_EXTERNAL_INT0 : (INTCONbits.INT0IE = 0); break;
            case INTERRUPT_EXTERNAL_INT1 : (INTCON3bits.INT1IE = 0); break;
            case INTERRUPT_EXTERNAL_INT2 : (INTCON3bits.INT2IE = 0); break;
            default : ret = (STD_ReturnType)0x00;
        }
    }
...
# 409 "MCAL_layer/Interrupt/mcal_external_interrupt.c"
static STD_ReturnType INTERRUPT_INTx_priority_int(const Interrupt_INTx_t *int_obj){
    STD_ReturnType ret = (STD_ReturnType)0x01;
    if(((void*)0) == int_obj)
    {
...
static STD_ReturnType INTERRUPT_INTx_clear_flag(const Interrupt_INTx_t *int_obj){
    ...
    {
       switch(int_obj->source){
            case INTERRUPT_EXTERNAL_INT0 : (INTCONbits.INT0IF = 0); break;
            case INTERRUPT_EXTERNAL_INT1 : (INTCON3bits.INT1IF = 0); break;
            case INTERRUPT_EXTERNAL_INT2 : (INTCON3bits.INT2IF = 0); break;
            default : ret = (STD_ReturnType)0x00;
       }
    }
