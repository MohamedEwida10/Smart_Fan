...
# 1 "MCAL_layer/TIMER3/../GPIO/../mcal_std_types.h" 1
# 13 "MCAL_layer/TIMER3/../GPIO/../mcal_std_types.h"
# 1 "MCAL_layer/TIMER3/../GPIO/../std_libraries.h" 1
# 14 "MCAL_layer/TIMER3/../GPIO/../std_libraries.h"
...
# 15 "MCAL_layer/TIMER3/../GPIO/../std_libraries.h" 2
# 13 "MCAL_layer/TIMER3/../GPIO/../mcal_std_types.h" 2

# 1 "MCAL_layer/TIMER3/../GPIO/../compiler.h" 1
# 12 "MCAL_layer/TIMER3/../GPIO/../compiler.h"
...
# 12 "MCAL_layer/TIMER3/../GPIO/../compiler.h" 2
# 14 "MCAL_layer/TIMER3/../GPIO/../mcal_std_types.h" 2
...
# 15 "MCAL_layer/TIMER3/../GPIO/../mcal_std_types.h" 2
...
# 1 "MCAL_layer/TIMER3/../GPIO/../device_config.h" 1
# 14 "MCAL_layer/TIMER3/../GPIO/hal_gpio.h" 2

# 1 "MCAL_layer/TIMER3/../GPIO/hal_gpio_cfg.h" 1
# 15 "MCAL_layer/TIMER3/../GPIO/hal_gpio.h" 2
# 36 "MCAL_layer/TIMER3/../GPIO/hal_gpio.h"
typedef enum {
    LOW = 0,
    HIGH
}logic_t;
...
# 13 "MCAL_layer/TIMER3/hal_Timer3.h" 2


# 1 "MCAL_layer/TIMER3/../Interrupt/mcal_internal_interrupt.h" 1
# 12 "MCAL_layer/TIMER3/../Interrupt/mcal_internal_interrupt.h"
# 1 "MCAL_layer/TIMER3/../Interrupt/mcal_interrupt_cfg.h" 1
# 15 "MCAL_layer/TIMER3/../Interrupt/mcal_interrupt_cfg.h"
# 1 "MCAL_layer/TIMER3/../Interrupt/mcal_interrupt_gen_cfg.h" 1
# 32 "MCAL_layer/TIMER3/../Interrupt/mcal_interrupt_gen_cfg.h"
typedef enum{
Interrupt_LOW_PRIORITY = 0,
Interrupt_HIGH_PRIORITY
}Interrupt_PRIORITY_cfg;
# 15 "MCAL_layer/TIMER3/../Interrupt/mcal_interrupt_cfg.h" 2
# 12 "MCAL_layer/TIMER3/../Interrupt/mcal_internal_interrupt.h" 2
# 15 "MCAL_layer/TIMER3/hal_Timer3.h" 2
# 47 "MCAL_layer/TIMER3/hal_Timer3.h"
typedef struct{
...
# 8 "MCAL_layer/TIMER3/hal_Timer3.c" 2




static void (*TMR3_INTERRUPT_HANDLER)(void) = ((void*)0);
...
STD_ReturnType ret = (STD_ReturnType)0x01;
    ...
    {
        (T3CONbits.TMR3ON = 0);
        (T3CONbits.T3CKPS = _timer->Prescaler_Value);
...
# 51 "MCAL_layer/TIMER3/hal_Timer3.c"
                (INTCONbits.GIE = 1);
                (INTCONbits.PEIE = 1);
...
static __attribute__((inline)) void timer3_mode_select(const TIMER3_t *_timer){
    if(0 == _timer->timer3_mode){
        ...
        (T3CONbits.TMR3CS = 1);
        if(1 == _timer->timer3_counter_mode){
            (T3CONbits.T3SYNC = 1);
        }
        else if(0 == _timer->timer3_counter_mode){
            (T3CONbits.T3SYNC = 0);
        }
        else{ }
    }
