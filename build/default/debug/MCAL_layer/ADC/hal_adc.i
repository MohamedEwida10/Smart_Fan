...
# 13 "MCAL_layer/ADC/../../MCAL_layer/GPIO/../mcal_std_types.h"
...
# 12 "MCAL_layer/ADC/../../MCAL_layer/GPIO/../compiler.h" 2
# 14 "MCAL_layer/ADC/../../MCAL_layer/GPIO/../mcal_std_types.h" 2
...
# 15 "MCAL_layer/ADC/../../MCAL_layer/GPIO/../mcal_std_types.h" 2
...
# 36 "MCAL_layer/ADC/../../MCAL_layer/GPIO/hal_gpio.h"
typedef enum {
    LOW = 0,
    HIGH
}logic_t;
...
# 15 "MCAL_layer/ADC/../../MCAL_layer/Interrupt/mcal_interrupt_cfg.h"
# 1 "MCAL_layer/ADC/../../MCAL_layer/Interrupt/mcal_interrupt_gen_cfg.h" 1
# 32 "MCAL_layer/ADC/../../MCAL_layer/Interrupt/mcal_interrupt_gen_cfg.h"
typedef enum{
Interrupt_LOW_PRIORITY = 0,
Interrupt_HIGH_PRIORITY
}Interrupt_PRIORITY_cfg;
# 15 "MCAL_layer/ADC/../../MCAL_layer/Interrupt/mcal_interrupt_cfg.h" 2
# 12 "MCAL_layer/ADC/../../MCAL_layer/Interrupt/mcal_internal_interrupt.h" 2
# 16 "MCAL_layer/ADC/hal_adc.h" 2
# 97 "MCAL_layer/ADC/hal_adc.h"
typedef enum{
    ADC_CHANNEL_AN0 = 0,
    ADC_CHANNEL_AN1,
    ADC_CHANNEL_AN2,
...
static void (*ADC_INTERRUPT_HANDLER)(void) = ((void*)0);
...
STD_ReturnType ADC_GetConversionResult(const adc_conf_t *_adc,ADC_result_t *conversion_result){
  STD_ReturnType ret = (STD_ReturnType)0x01;
    ...
    {
        if(_adc->result_format == 0x01){
            *conversion_result = (ADC_result_t)((ADRESH << 8)+ADRESL);
        }
        else if(_adc->result_format == 0x00){
...
static void ADC_voltage_reference_configuration(const adc_conf_t *_adc){
    if(_adc->voltage_reference == 0x01){

        do{ADCON1bits.VCFG1 = 1;ADCON1bits.VCFG0 = 1;}while(0);
    }
    else if(_adc->voltage_reference == 0x00){
