...
# 13 "MCAL_layer/CCP1/../GPIO/hal_gpio.h"
# 1 "MCAL_layer/CCP1/../GPIO/../mcal_std_types.h" 1
# 13 "MCAL_layer/CCP1/../GPIO/../mcal_std_types.h"
# 1 "MCAL_layer/CCP1/../GPIO/../std_libraries.h" 1
# 14 "MCAL_layer/CCP1/../GPIO/../std_libraries.h"
...
# 14 "MCAL_layer/CCP1/../GPIO/../std_libraries.h" 2
...
# 15 "MCAL_layer/CCP1/../GPIO/../std_libraries.h" 2
# 13 "MCAL_layer/CCP1/../GPIO/../mcal_std_types.h" 2

# 1 "MCAL_layer/CCP1/../GPIO/../compiler.h" 1
# 12 "MCAL_layer/CCP1/../GPIO/../compiler.h"
...
# 12 "MCAL_layer/CCP1/../GPIO/../compiler.h" 2
# 14 "MCAL_layer/CCP1/../GPIO/../mcal_std_types.h" 2
...
# 15 "MCAL_layer/CCP1/../GPIO/../mcal_std_types.h" 2
...
# 13 "MCAL_layer/CCP1/../GPIO/hal_gpio.h" 2

# 1 "MCAL_layer/CCP1/../GPIO/../device_config.h" 1
# 14 "MCAL_layer/CCP1/../GPIO/hal_gpio.h" 2

# 1 "MCAL_layer/CCP1/../GPIO/hal_gpio_cfg.h" 1
# 15 "MCAL_layer/CCP1/../GPIO/hal_gpio.h" 2
# 36 "MCAL_layer/CCP1/../GPIO/hal_gpio.h"
typedef enum {
    LOW = 0,
    HIGH
}logic_t;
...
# 1 "MCAL_layer/CCP1/../Interrupt/mcal_interrupt_cfg.h" 1
# 15 "MCAL_layer/CCP1/../Interrupt/mcal_interrupt_cfg.h"
# 1 "MCAL_layer/CCP1/../Interrupt/mcal_interrupt_gen_cfg.h" 1
# 32 "MCAL_layer/CCP1/../Interrupt/mcal_interrupt_gen_cfg.h"
typedef enum{
Interrupt_LOW_PRIORITY = 0,
Interrupt_HIGH_PRIORITY
}Interrupt_PRIORITY_cfg;
# 15 "MCAL_layer/CCP1/../Interrupt/mcal_interrupt_cfg.h" 2
...
static void (*CCP1_INTERRUPT_HANDLER)(void) = ((void*)0);



static void (*CCP2_INTERRUPT_HANDLER)(void) = ((void*)0);
...
static void CCP_PWM_Mode_Config(const ccp_t *_ccp_obj){
    ...
    PR2 = (uint8)(((float)8000000ul / ((float)_ccp_obj->pwm_freq * 4.0 *
                   (float)_ccp_obj->Postscaler_Value * (float)_ccp_obj->Prescaler_Value)) - 1);

    if(CCP1_INST == _ccp_obj->ccp_inst){
        if(_ccp_obj->ccp_sub_mode == 12){
            (CCP1CONbits.CCP1M = 12) ;
        }
        else{ }
        }
...
static void CCP_Capture_Mode_Config(const ccp_t *_ccp_obj){
    ...
    if(CCP1_INST == _ccp_obj->ccp_inst){
        ...
        switch(_ccp_obj->ccp_sub_mode){
            case 4 : (CCP1CONbits.CCP1M = 4); break;
            case 5 : (CCP1CONbits.CCP1M = 5); break;
            case 6 : (CCP1CONbits.CCP1M = 6); break;
            case 7 : (CCP1CONbits.CCP1M = 7); break;
            default : ;
        }
    }
    else if(CCP2_INST == _ccp_obj->ccp_inst){
        ...
        switch(_ccp_obj->ccp_sub_mode){
            case 4 : (CCP2CONbits.CCP2M = 4); break;
            case 5 : (CCP2CONbits.CCP2M = 5); break;
            case 6 : (CCP2CONbits.CCP2M = 6); break;
            case 7 : (CCP2CONbits.CCP2M = 7); break;
            default : ;
        }
    }
    else{ }
...
static void CCP_Compare_Mode_Config(const ccp_t *_ccp_obj){
    ...
    if(CCP1_INST == _ccp_obj->ccp_inst){
        ...
        switch(_ccp_obj->ccp_sub_mode){
            case 8 : (CCP1CONbits.CCP1M = 8) ;break;
            case 9 : (CCP1CONbits.CCP1M = 9) ;break;
            case 2 : (CCP1CONbits.CCP1M = 2) ;break;
            case 10 : (CCP1CONbits.CCP1M = 10);break;
            case 11 : (CCP1CONbits.CCP1M = 11) ;break;
            default : ;
        }
    }
    else if(CCP2_INST == _ccp_obj->ccp_inst){
        ...
        switch(_ccp_obj->ccp_sub_mode){
            case 8 : (CCP2CONbits.CCP2M = 8) ;break;
            case 9 : (CCP2CONbits.CCP2M = 9) ;break;
            case 2 : (CCP2CONbits.CCP2M = 2) ;break;
            case 10 : (CCP2CONbits.CCP2M = 10);break;
            case 11 : (CCP2CONbits.CCP2M = 11) ;break;
            default : ;
        }
    }
    else{ }
