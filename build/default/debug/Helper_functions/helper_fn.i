# 1 "Helper_functions/helper_fn.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "Helper_functions/helper_fn.c" 2
...
# 13 "Helper_functions/helper_fn.h"
# 1 "Helper_functions/../application.h" 1
# 13 "Helper_functions/../application.h"
...
# 36 "./ECU_layer/LED/../../MCAL_layer/GPIO/hal_gpio.h"
typedef enum {
    LOW = 0,
    HIGH
}logic_t;
...
# 23 "./ECU_layer/Relay/ecu_relay.h"
typedef struct{
    uint8 relay_port :4 ;
    uint8 relay_pin :3 ;
...
# 25 "./ECU_layer/7_segment/ecu_seven_segment.h"
typedef enum{
...
# 1 "./ECU_layer/Keypad/ecu_ketpad_cfg.h" 1
...
# 1 "./ECU_layer/../MCAL_layer/Interrupt/mcal_external_interrupt.h" 1
# 13 "./ECU_layer/../MCAL_layer/Interrupt/mcal_external_interrupt.h"
# 1 "./ECU_layer/../MCAL_layer/Interrupt/mcal_interrupt_cfg.h" 1
# 15 "./ECU_layer/../MCAL_layer/Interrupt/mcal_interrupt_cfg.h"
# 1 "./ECU_layer/../MCAL_layer/Interrupt/mcal_interrupt_gen_cfg.h" 1
# 32 "./ECU_layer/../MCAL_layer/Interrupt/mcal_interrupt_gen_cfg.h"
typedef enum{
Interrupt_LOW_PRIORITY = 0,
Interrupt_HIGH_PRIORITY
}Interrupt_PRIORITY_cfg;
# 15 "./ECU_layer/../MCAL_layer/Interrupt/mcal_interrupt_cfg.h" 2
# 13 "./ECU_layer/../MCAL_layer/Interrupt/mcal_external_interrupt.h" 2
# 89 "./ECU_layer/../MCAL_layer/Interrupt/mcal_external_interrupt.h"
...
# 1 "./ECU_layer/../MCAL_layer/EEPROM/hal_eeprom.h" 1
# 12 "./ECU_layer/../MCAL_layer/EEPROM/hal_eeprom.h"
# 1 "./ECU_layer/../MCAL_layer/EEPROM/../Interrupt/mcal_internal_interrupt.h" 1
# 12 "./ECU_layer/../MCAL_layer/EEPROM/hal_eeprom.h" 2
# 25 "./ECU_layer/../MCAL_layer/EEPROM/hal_eeprom.h"
STD_ReturnType Data_EEPROM_WriteByte(uint16 badd,uint8 bData);
STD_ReturnType Data_EEPROM_ReadByte(uint16 badd,uint8 *bData);
# 22 "./ECU_layer/ecu_layer_init.h" 2

# 1 "./ECU_layer/../MCAL_layer/ADC/hal_adc.h" 1
# 13 "./ECU_layer/../MCAL_layer/ADC/hal_adc.h"
# 1 "./ECU_layer/../MCAL_layer/ADC/hal_adc_cfg.h" 1
# 13 "./ECU_layer/../MCAL_layer/ADC/hal_adc.h" 2
# 97 "./ECU_layer/../MCAL_layer/ADC/hal_adc.h"
typedef enum{
    ADC_CHANNEL_AN0 = 0,
    ADC_CHANNEL_AN1,
    ADC_CHANNEL_AN2,
...
# 1 "./ECU_layer/../MCAL_layer/Timer/hal_timer0.h" 1
# 49 "./ECU_layer/../MCAL_layer/Timer/hal_timer0.h"
typedef enum{
...
# 1 "./ECU_layer/../MCAL_layer/TIMER1/hal_Timer1.h" 1
# 58 "./ECU_layer/../MCAL_layer/TIMER1/hal_Timer1.h"
typedef struct{
...
# 25 "./ECU_layer/ecu_layer_init.h" 2

# 1 "./ECU_layer/../MCAL_layer/TIMER2/hal_Timer2.h" 1
# 47 "./ECU_layer/../MCAL_layer/TIMER2/hal_Timer2.h"
typedef struct{
...
# 26 "./ECU_layer/ecu_layer_init.h" 2

# 1 "./ECU_layer/../MCAL_layer/TIMER3/hal_Timer3.h" 1
# 47 "./ECU_layer/../MCAL_layer/TIMER3/hal_Timer3.h"
typedef struct{
...
# 27 "./ECU_layer/ecu_layer_init.h" 2

# 1 "./ECU_layer/../MCAL_layer/CCP1/hal_ccp.h" 1
# 16 "./ECU_layer/../MCAL_layer/CCP1/hal_ccp.h"
# 1 "./ECU_layer/../MCAL_layer/CCP1/ccp_cfg.h" 1
# 16 "./ECU_layer/../MCAL_layer/CCP1/hal_ccp.h" 2
# 67 "./ECU_layer/../MCAL_layer/CCP1/hal_ccp.h"
typedef enum{
...
# 133 "./ECU_layer/../MCAL_layer/CCP1/hal_ccp.h"
...
# 28 "./ECU_layer/ecu_layer_init.h" 2
...
# 13 "Helper_functions/../application.h" 2




# 1 "./Helper_functions/helper_fn.h" 1
# 17 "Helper_functions/../application.h" 2
# 32 "Helper_functions/../application.h"
void Application_Initialization(void);
# 13 "./Helper_functions/helper_fn.h" 2
...
# 14 "./Helper_functions/helper_fn.h" 2
...
keypad_value = 0;
     ...
     while(1){
        ...
        _delay((unsigned long)((160)*(8000000ul/4000.0)));
        }while((keypad_value == 0) );

        if(keypad_value == '#' && *counter > 0 ){
           (*counter)--;
           time[*counter] = '\0';
           (lcd_counter)--;
...
*time_value = *time_value + (arr[count] - 48)* (powf(10,count_power));
count_power--;
}
}
